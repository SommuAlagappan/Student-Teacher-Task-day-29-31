...
function Teachers() {
 ...
 const[isLoading,setLoading]=useState(false)
    ...
    let Loaddata= async()=>{
        setLoading(true)
        let user= await axios.get(`https://6305f395dde73c0f844f7176.mockapi.io/Teachers`)
        setData(user.data)
        setLoading(false)
    }
    ...
    try{
      ...
      if(ask){
          await axios.delete(`https://6305f395dde73c0f844f7176.mockapi.io/Teachers/${identity}`)
