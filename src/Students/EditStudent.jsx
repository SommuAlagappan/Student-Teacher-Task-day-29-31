...
function EditStudent() {
  ...
  const formik = useFormik({
    ...
    onSubmit:async(values)=>{
      console.log(values)
      await axios.put(`https://6305f395dde73c0f844f7176.mockapi.io/Students/${params.id}`,values)
      alert('Sudent details updated')
   ...
   let Loaduser=async()=>{
    try{
    let user= await axios.get(`https://6305f395dde73c0f844f7176.mockapi.io/Students/${params.id}`)
      formik.setValues({
        Name:user.data.Name,
        DOB:user.data.DOB,
